      ...
      >
        <motion.div variants={fadeUp}>
          <Heading
            ...
            title="A simple process that does not waste your time"
          />
        </motion.div>
        ...
        <div className="grid gap-6 lg:grid-cols-3">
          {processSteps.map((step) => (
            ...
            >
              <Card className="relative h-full overflow-hidden p-8 transition-colors duration-300 hover:border-slate-300 hover:bg-slate-50">
                <div className="pointer-events-none absolute inset-x-0 top-0 h-px bg-gradient-to-r from-transparent via-sky-300/50 to-transparent opacity-0 transition-opacity duration-300 hover:opacity-100" />
        ...
        <motion.p
          ...
          variants={fadeUp}
        >
          Simple communication. Fast turnaround. No chaos.
        </motion.p>
      </motion.div>
    </Section>
  )
